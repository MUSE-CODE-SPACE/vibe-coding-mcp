...
const PROMPTS: PromptDefinition[] = [
  {
    descriptor: {
      name: 'daily-vibe-log',
      description:
        'Generate a daily vibe coding log summarizing today\'s captured sessions, code contexts, and design decisions.',
      arguments: [
        {
          name: 'date',
  ...
  },
  {
    descriptor: {
      ...
      description:
        'Walk a user through documenting a captured vibe coding session — fetch it, extract design decisions, generate a dev document, and (optionally) publish.',
      arguments: [
        {
          name: 'sessionId',
        ...
        },
        {
          name: 'platform',
          description:
            'Optional publish target: notion, github-wiki, obsidian, confluence, slack, discord. Omit to skip publish.',
          required: false,
        },
      ],
    },
  ...
  },
  {
    descriptor: {
      ...
      description:
        'Extract the refactor-ready context from a session: the code that changed, the design decisions that drove the change, and AST analysis of the new code — ready to paste into a refactor PR description.',
      arguments: [
        {
          name: 'sessionId',
